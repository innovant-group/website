        ...
        <div className="form-container">
            ...
            <div className="SR-box">
                 ...
                 <div className="box-left">   
                    <img className='left-icon' src="https://img.icons8.com/material/24/000000/add-user-male--v1.png"/>
